...
const roles: Record<RoleId, RoleConfig> = {
  ...
  finance: {
    ...
    accent: "#245b8a",
    owner: "Phòng Tài chính Tào Phớ 88",
  ...
  control: {
    ...
    icon: ShieldCheck,
    accent: "#9a4b2b",
    owner: "Kiểm soát nội bộ Tào Phớ 88",
  ...
  "super-admin": {
    ...
    location: "Toàn hệ thống Tào Phớ 88",
...
function Brand() {
  return (
    <span className={styles.brand} aria-label="Tào Phớ 88">
      <span>Tào Phớ</span><b>88</b><small>WORKSPACE</small>
    </span>
  );
}
...
export default function PortalPage() {
  ...
  const renderFinance = () => {
    ...
    const roleSummaryCopy: Record<RoleId, string> = {
      ...
      "super-admin": "Báo cáo hợp nhất loại giao dịch nội bộ, tách GMV hệ sinh thái khỏi doanh thu TP88 ghi nhận.",
    };
    const financeCards = role.id === "super-admin" ? [
      ...
      { label: "Doanh thu TP88 ghi nhận", value: compactMoney(recognizedRevenue), note: "Tổng từ phân bổ đơn hàng đã posted", tone: "dark" },
